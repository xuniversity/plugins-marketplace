...
After initialization, wire the placeholder API adapters under `src/api/`, review dependency and alias checks printed by the script, then run the target project's formatter and typecheck.
